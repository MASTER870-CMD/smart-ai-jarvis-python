                ...
                if "build" in cmd or "code" in cmd or "create a website" in cmd:
                    ...
                    try:
                        ...
                        sys_prompt = (
                            ...
                            "Create a LUXURIOUS, Single-Page Website with Animations."
                            "CRITICAL RULES:"
                            "1. OUTPUT ONLY CODE. Start with <!DOCTYPE html> and end with </html>."
                            "2. Do NOT write filenames like '**index.html**' or any markdown ticks."
                            "3. MERGE EVERYTHING: Put CSS inside <style> tags and JS inside <script> tags within the HTML."
                            "4. DESIGN: Premium Dark/Gold Theme. Parallax effects. Glassmorphism."
                            "5. IMAGES: Use 'https://source.unsplash.com/1600x900/?luxury,hotel' (change query for context)."
                        )
